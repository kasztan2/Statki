...
void inicjujKolory()
{
    ...
    init_pair(KOLOR_USTAWIANIE_NA_CZERWONYM, COLOR_MAGENTA, COLOR_RED);
    init_pair(KOLOR_USTAWIANIE_NA_NIEBIESKIM, COLOR_MAGENTA, COLOR_BLUE);
    init_pair(KOLOR_USTAWIANIE_NA_ZIELONYM, COLOR_MAGENTA, COLOR_GREEN);
    init_pair(KOLOR_USTAWIANIE_NA_ZOLTYM, COLOR_MAGENTA, COLOR_YELLOW);
}
